@extends('layouts.cms')
@section('title')
{{__('caption.cms.menu-item.comment-menu.add' )}}
@endsection
<?php $is_RTL = \Config::get('app.locale') == 'ar';  ?>
@section('content')
<div class="row">
	<div class="col-12">
		<h1>{{__('caption.cms.menu-item.comment-menu.add' )}}</h1>
	</div>
</div>
...
<div class="row">
	<div class="col-12">
		<a href="{{route('comment.index')}}" class="btn btn-outline-primary btn-lg">{{__('caption.cms.menu-item.comment-menu.index')}}</a>
	</div>
</div>
@endsection
